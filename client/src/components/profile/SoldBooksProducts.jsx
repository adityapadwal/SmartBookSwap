...
const SoldBooksProducts = ({ productTitle, productPublicationOrAuthor, productMrp, productPhoto, productQuantity, productPurchaseDate, buyerName, buyerAddress }) => {
...
export default SoldBooksProducts